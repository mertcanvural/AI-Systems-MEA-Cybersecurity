...
def download_movielens(output_dir, dataset='ml-1m'):
    ...
    if not os.path.exists(csv_path):
        ...
        if dataset == 'ml-1m':
            ...
            with open(ratings_path, 'r', encoding='iso-8859-1') as f, open(csv_path, 'w') as out:
                # write header
...
def main():
    parser = argparse.ArgumentParser(description='download datasets for gro defense')
    parser.add_argument('--output_dir', type=str, default='data', 
                        help='directory to save the datasets')
    parser.add_argument('--datasets', type=str, nargs='+', default=['ml-1m'],
